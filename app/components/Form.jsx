    ...
    <form className="flex flex-col gap-6" onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className="flex flex-col gap-1">
        ...
        <div className="flex items-center h-[34px] rounded-md shadow border-[1px] gap-1 hover:border-[#9B9EA3] focus-within:outline-[#3F8F6B] ">
          <select
            className="border-none outline-0 shadow-none bg-transparent py-3 px-2 justify-center gap-1"
            id="prefijo"
            name="prefijo"
          >
      ...
      <div>
        ...
        <textarea
          className="w-[470px] rounded-md shadow border-[1px] py-3 px-4 hover:border-[#9B9EA3] focus-within:outline-[#3F8F6B]"
      ...
      <div className="flex items-center gap-3">
        ...
        <label class="terminosYcondiciones" for="acepto">
          {" "}
          Acepto la{" "}
          <b>
