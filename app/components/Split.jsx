...
const Split = () => {
  ...
  return (
    <div
      ...
      className="flex bg-[#E3DED7] px-10 font-outfit gap-6 justify-center "
    >
      <div className="flex flex-col justify-center w-[588px]">
        <div className="flex flex-col gap-3">
          ...
          <p className="font-normal text-sm pb-8">
        ...
        <div className="flex flex-col gap-6 font-normal text-sm">
          ...
          <div className="flex flex-col gap-3">
            <button className="flex  items-center gap-3 text-[#6B7280]">
